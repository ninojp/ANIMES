...
<div class="row align_center">
    ...
    <div class="row align_center">
        <div data-bs-placement="top" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Listar os Animes por LETRA" class="col-9 nav nav-tabs align_center">
            <div class="nav-item px-2"><a class="nav-link active px-2" href="form_busca.php?input_busca=a">B</a></div>
