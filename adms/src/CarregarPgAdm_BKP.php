...
class CarregarPgAdm
{
    ...
    {
        $this->classLoad = "\\App\\site\\Controllers\\".$this->urlController;
    ...
    {
        $this->listPgPrivate = ["Dashboard", "ListUser", "ViewUsers", "AddUsers", "EditUsers", "EditUsersPassword", "EditUsersImage", "DeleteUsers", "ViewProfile", "EditProfile", "EditProfilePassword", "EditProfileImage", "ListSitsUsers", "ViewSitsUsers", "AddSitsUsers", "EditSitsUsers", "DeleteSitsUsers", "ListColors", "ViewColors", "AddColors", "EditColors", "DeleteColors", "ListEmailConfs", "ViewEmailConfs", "EditEmailConfs", "EditEmailConfsPass", "AddEmailConfs", "DeleteEmailConfs", "ListAccessNivels", "ViewAccessNivels", "AddAccessNivels", "EditAccessNivels", "DeleteAccessNivels", "OrderAccessNivels", "ListTypesPgs", "ViewTypesPgs", "AddTypesPgs", "EditTypesPgs", "DeleteTypesPgs", "OrderTypesPgs", "ListSitsPgs", "ViewSitsPgs", "AddSitsPgs", "EditSitsPgs", "DeleteSitsPgs", "ListGroupsPgs", "ViewGroupsPgs", "AddGroupsPgs", "EditGroupsPgs", "DeleteGroupsPgs", "OrderGroupsPgs", "ListPage", "ViewPages", "AddPages", "EditPages", "DeletePages", "ListPermission", "SyncPagesNivels", "EditPermission"];
    ...
    {
        if((isset($_SESSION['id_user'])) and (isset($_SESSION['adm_user'])) and (isset($_SESSION['adm_email'])) ){
            $this->classLoad = "\\App\\adms\\Controllers\\".$this->urlController;
        }else{
