...
class MdListSeriesAdm
{
    ...
    public function listSeries(int $page=null):void
    {
        ...
        $pagination = new \Adms\Models\helper\AdmsPagination(URLADM.'list-series-adm/index');
        $pagination->condition($this->page, $this->limitResult);
        $pagination->pagination("SELECT COUNT(id_serie) AS num_result FROM serie");
        $this->resultPg = $pagination->getResult();
        //-------------------------------------------------------------------------------------
        $listSeries = new \Adms\Models\helper\AdmsRead();
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 157! Nenhum registro encontrado!</p>";
            $this->result = false;
        }
    }
    /** ========================================================================================== */
    ...
    {
        $pagination = new \Adms\Models\helper\AdmsPagination(URLADM.'list-series-adm/index', "?search_name={$this->searchName}");
        $pagination->condition($this->page, $this->limitResult);
        ...
        $this->resultPg = $pagination->getResult();
        //-------------------------------------------------------------------------------------
        $listUsersNameSerie = new \Adms\Models\helper\AdmsRead();
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 157.1! Nenhum registro encontrado!</p>";
            $this->result = false;
        }
    }
}