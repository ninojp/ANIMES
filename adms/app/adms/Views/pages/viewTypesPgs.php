...
<div class="wrapper_form">
    ...
    ?>
        ...
        <div class="col-12 text-center p-4">
            ...
            <a class="btn btn-sm btn-outline-danger mx-1" href="<?= URLADM; ?>delete-types-pgs/index/<?= $id; ?>" onclick="return confirm('Tem certeza que deseja excluir o registro?')"><i class='fa-solid fa-trash-can'></i> Apagar</a>
        </div>
        <?php } ?>
    </div>
</div>
