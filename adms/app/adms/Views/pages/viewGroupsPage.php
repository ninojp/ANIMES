    ...
    <div class="row_form">
        ...
        <?php echo "<div id='msg' class='msg_alert'>";
            if (isset($_SESSION['msg'])) {
                ...
                unset($_SESSION['msg']); }
            echo "</div>";
            if (!empty($this->data['viewGroupsPgs'])) {
            ...
            <div class="content_adm">
                ...
                <?php if ((!empty($this->data['button']['list_groups_page'])) or (!empty($this->data['button']['edit_groups_page'])) or (!empty($this->data['button']['delete_groups_page'])) or (!empty($this->data['button']['add_groups_page']))) {
                    echo "<div class='col-12 text-center p-4'>";
                    if (!empty($this->data['button']['list_groups_page'])) {
                        echo "<a class='btn btn-sm btn-outline-primary mx-1' href='" . URLADM . "list-groups-page/index'><i class='fa-solid fa-list'></i> Listar</a>";
                    }
                    if (!empty($this->data['button']['add_groups_page'])) {
                        echo "<a class='btn btn-sm btn-outline-success mx-1' href='" . URLADM . "add-groups-page/index'><i class='fa-solid fa-plus'></i> Adicionar</a>";
                    }
                    if (!empty($this->data['button']['edit_groups_page'])) {
                    ...
                    if (!empty($this->data['button']['delete_groups_page'])) {
