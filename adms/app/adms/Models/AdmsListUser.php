...
class AdmsListUser
{
    ...
    public function listUsers(int $page = null): void
    {
        ...
        $pagination->pagination("SELECT COUNT(usr.id_user) AS num_result FROM adms_user AS usr INNER JOIN adms_access_level AS lev ON lev.id_access_level=usr.id_access_level 
        WHERE lev.order_level >:order_level", "order_level=".$_SESSION['order_level']);
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 030! Nenhum usuário encontrado!</p>";
            $this->result = false;
        }
    }
    /** ============================================================================================
    ...
    public function searchUserNameEmail(): void
    {
        ...
        WHERE (lev.order_level >:order_level) AND ((usr.adm_user LIKE :search_name) OR (usr.adm_email LIKE :search_email))",
        "order_level=".$_SESSION['order_level']."&search_name={$this->searchNameValue}&search_email={$this->searchEmailValue}");
        //recebe o resultado do método:getResult() e atribui para:$this->resultPg
        $this->resultPg = $pagination->getResult();
        // var_dump($this->resultPg);
        //-------------------------------------------------------------------------------------
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 030.1! Nenhum usuário ou e-mail encontrado!</p>";
            $this->result = false;
        }
    }
    /** ============================================================================================
    ...
    public function searchUserName(): void
    {
        ...
        "order_level=".$_SESSION['order_level']."&search_name={$this->searchNameValue}");
        //recebe o resultado do método:getResult() e atribui para:$this->resultPg
        $this->resultPg = $pagination->getResult();
        // var_dump($this->resultPg);
        //-------------------------------------------------------------------------------------
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 031.2! Nenhum usuário encontrado!</p>";
            $this->result = false;
        }
    }
    /** ============================================================================================
    ...
    public function searchUserEmail(): void
    {
        ...
        if ($this->resultBd) {
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 031.3! Nenhum e-mail encontrado!</p>";
            $this->result = false;
        }
    }
}
