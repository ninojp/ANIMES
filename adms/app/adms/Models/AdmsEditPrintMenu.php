...
class AdmsEditPrintMenu
{
    ...
    public function editPrintMenu(int $id_level_page):void
    {
        $this->id_level_page = $id_level_page;
        // var_dump($this->id);

        $vieweditPrintMenu = new \Adms\Models\helper\AdmsRead();
        $vieweditPrintMenu->fullRead("SELECT lev_pag.id_level_page, lev_pag.print_menu
        ...
        if($this->resultBd){
            ...
            $_SESSION['msg'] = "<p class='alert alert-danger'>Erro 055! Necessário selecionar um item de menu!</p>";
            $this->result = false;
        }
    }
    /** ===========================================================================================
    ...
    private function edit():void
    {
        ...
        if($upPrintMenu->getResult()){
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 055.1! Não foi possível Editar o Item de Menu</p>";
            $this->result = false;
        }
    }
}
