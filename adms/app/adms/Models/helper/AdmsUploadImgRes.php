...
class AdmsUploadImgRes
{
    ...
    private function createDir():void
    {
        ...
        if(!file_exists($this->directory)){
            $_SESSION['msg'] = "<p class='alert alert-info'>Erro 044! Upload da imagem não realizado com sucesso</p>";
        $this->result = false;
        } else {
            $this->uploadFile();
        }
    ...
    private function uploadFile():void
    {
        switch ($this->imageData['type']) {
            ...
            case 'image/x-png':
                ...
                break;
            default:
        $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 044.1! Necessário selecionar uma imagem JPEG ou PNG!</p>";
        $this->result = false;
        }
    ...
    private function uploadFileJpeg():void
    {
        ...
        if(imagejpeg($this->imgResize, $this->directory.$this->name, 100)){
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 044.2! Upload da imagem não realizado com sucesso, tente novamente</p>";
            $this->result = false;
        }
    ...
    private function uploadFilePng():void
    {
        ...
        if(imagepng($this->imgResize, $this->directory.$this->name, 0)){
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro 044.3! Upload da imagem não realizado com sucesso, tente novamente</p>";
            $this->result = false;
        }
